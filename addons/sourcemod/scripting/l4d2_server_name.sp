...
public void OnPluginStart()
{
	...
	g_hAllowDisplayMode = CreateConVar("sn_display_mode_info", "1", "是否在当前服名中显示什么模式,0=关", CVAR_FLAG, true, 0.0, true, 1.0);
...
void setServerName()
{
	...
	char ModeName[MODE][128] = {"[纯净战役]","[绝境战役]","[多特战役]","[写专多特]","[无限火力]","[困难无限]","[药役A]","[药役B]","[药役C]","[药役D]","[单人药役]","[HT训练]","[HT x Witch]"};
